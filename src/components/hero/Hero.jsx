...
const Hero = () => {
  ...
  return (
    <Motion.section ref={setRefs} initial="hidden" animate={controls} variants={fadeUp} className="relative inset-0 flex flex-col justify-start items-center text-center overflow-visible py-20 px-1 bg-primary-02">
      ...
      <div className="relative z-10 text-gray-800 max-w-[600px]">
        ...
        <Motion.h2 variants={fadeScale} transition={{ delay: 0.4 }} className="text-3xl font-playwrite mb-2 text-primary-01">
          Fatra & Fitri
        </Motion.h2>
      ...
      {/* Foto Mempelai */}
      <Motion.img src={fotoMempelai} alt="foto mempelai" variants={fadeScale} transition={{ delay: 0.8 }} className="relative z-10 max-w-[320px] h-auto rounded-xl shadow-lg mt-6 border-2 border-gray-800/50" />

      {/* Ayat Qur'an */}
      <Motion.div variants={fadeUp} transition={{ delay: 1.0 }} className="relative z-30 mt-40 mb-16 px-6">
        <div className="bg-primary-01/25 backdrop-blur-sm rounded-2xl border border-gray-800/50 px-5 py-6 max-w-[350px] mx-auto text-white shadow-md">
          <p className="font-playwrite text-justify text-lg leading-relaxed mb-3">
